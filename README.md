...
## Дизайн-концент
Дизайн был разработан по принципу __modile-first__, в первую очередь для мобильного устройства. Стили были написаны с опорой на __неоморфизм,__ один из самых актуальных трендов в веб-дизайне
